...
function Package-OBS {
    ...
    if ($CombinedArchs.isPresent) {
        ...
        Invoke-Expression "cmake --build `"${BuildDirectory}64`" --config ${BuildConfiguration} -t package"
        ...
        Invoke-Expression "cmake --build `"${BuildDirectory}32`" --config ${BuildConfiguration} -t package"
